...
### Inyección DLL
Realizando un `whoami /all` podemos ver que el usuario **ryan** se encuentra dentro del grupo locale **Contractors** y que este a su vez se encuentra dentro de **DnsAdmins**, convirtiendo a **ryan** en miembro de **DnsAdmins**.
